...
const EnvelopeIcon = () => (
  <svg className="contact-footer__icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
        ...
        <div className="container contact-footer__inner">
          <div className="contact-footer__left">
            <h2 className="contact-footer__heading">
              Want to <em>reach out?</em>
            </h2>
            <div className="contact-footer__offices">
              {OFFICES.map((office) => (
                <div key={office.city} className="contact-footer__office">
          ...
          <div className="contact-footer__right">
            <h3 className="contact-footer__form-title">Get In Touch</h3>
      ...
      <div className="contact-footer__bottom">
        <div className="container contact-footer__bottom-inner">
          ...
          <nav className="contact-footer__links" aria-label="Footer">
            {FOOTER_LINKS.map((link) => (
              <a key={link.label} href={link.href} className="contact-footer__nav-link">
                {link.label}
              </a>
            ))}
          </nav>
        ...
        <div className="contact-footer__copyright">
          <div className="container contact-footer__copyright-inner">
            <span>© 2025 ADNH Catering PLC, All Rights Reserved.</span>
            <span className="contact-footer__credit">Handcrafted by 2Base Technologies</span>
          </div>
        </div>
      </div>
    </footer>
